...
if [ ! -f "/opt/wso2am/repository/conf/initialized" ]; then
  ...
  saxonb-xslt -s:/opt/wso2am/repository/conf/carbon.xml -xsl:/tmp/carbon.xsl -o:/opt/wso2am/repository/conf/carbon.xml hostname=$EXTERNAL_HOSTNAME password=$PRIVATE_KEY_PASSWORD keystore=/opt/wso2am/repository/resources/security/wso2carbon.jks alias=wso2carbon
  ...
  saxonb-xslt -s:/opt/wso2am/repository/conf/identity.xml -xsl:/tmp/identity.xsl -o:/opt/wso2am/repository/conf/identity.xml hostname=$EXTERNAL_HOSTNAME
